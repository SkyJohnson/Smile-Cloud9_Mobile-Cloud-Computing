...
def main(rank, world):
	if rank == 0:
		...
		for epoch in range(1):  # loop over the dataset multiple times
			...
			for i, data in enumerate(trainloader, 0):
				...
				if i % 2000 == 1999:    # print every 2000 mini-batches
					print('NODE 0: [%d, %5d] loss: %.3f, time: %s' %(epoch + 1, i + 1, running_loss / 2000,time_batch_node_0))
					running_loss = 0.0
		...
		print("Node 0's node weight is now the average of the node weights:")
		...
		for epoch in range(1):  # loop over the dataset multiple times
			...
			for i, data in enumerate(trainloader, 0):
				...
				if i % 2000 == 1999:    # print every 2000 mini-batches
					print('NODE 1: [%d, %5d] loss: %.3f, time: %s' %(epoch + 1, i + 1, running_loss / 2000,time_batch_node_1))
					running_loss = 0.0
